...
export const metadata: Metadata = {
	...
	description:
		"Bet2Gether is a decentralized prediction game powered by Ethereum (Sepolia), Alchemy, Chainlink and Tenderly. Create games to bet on asset prices, join others' games, and earn rewards based on your predictions.",
};
